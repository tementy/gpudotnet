...
namespace OpenCL.Net
{
    public static partial class Cl
    {
		...
		public static ErrorCode SetKernelArg(Kernel kernel, uint argIndex, byte value)
        {
            return SetKernelArg(kernel, argIndex, sizeof(byte), value);
        }
		public static ErrorCode SetKernelArg(Kernel kernel, uint argIndex, ushort value)
        {
            return SetKernelArg(kernel, argIndex, sizeof(ushort), value);
        }
		public static ErrorCode SetKernelArg(Kernel kernel, uint argIndex, uint value)
        {
            return SetKernelArg(kernel, argIndex, sizeof(uint), value);
        }
		...
		public static ErrorCode SetKernelArg(Kernel kernel, uint argIndex, short value)
        {
            return SetKernelArg(kernel, argIndex, sizeof(short), value);
        }
		public static ErrorCode SetKernelArg(Kernel kernel, uint argIndex, int value)
        {
            return SetKernelArg(kernel, argIndex, sizeof(int), value);
        }
		public static ErrorCode SetKernelArg(Kernel kernel, uint argIndex, long value)
        {
            return SetKernelArg(kernel, argIndex, sizeof(long), value);
        }
		public static ErrorCode SetKernelArg(Kernel kernel, uint argIndex, float value)
        {
            return SetKernelArg(kernel, argIndex, sizeof(float), value);
        }
		public static ErrorCode SetKernelArg(Kernel kernel, uint argIndex, double value)
        {
            return SetKernelArg(kernel, argIndex, sizeof(double), value);
        }
		public static ErrorCode SetKernelArg(Kernel kernel, uint argIndex, bool value)
        {
            return SetKernelArg(kernel, argIndex, sizeof(byte), value ? (byte)1 : (byte)0);
        }
